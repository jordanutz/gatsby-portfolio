        ...
        <Row>
          <Col xs={6} sm={3} className="navigation__logo">
            <h2
              ...
              onClick={() => scrollView(slider, setToggleMenu)}
            >
              <Link to="/">JU</Link>
            </h2>
          </Col>
          <Col xs={18} sm={21}>
            <ul className="navigation__list">
              ...
              <li className="navigation__item">
                <button
                  className="navigation__item-btn"
                  onClick={() => scrollView(skills, setToggleMenu)}
                >
                  <span>02.</span>Skills
                </button>
              </li>
              <li className="navigation__item">
                <button
                  className="navigation__item-btn"
                  onClick={() => scrollView(experience, setToggleMenu)}
                >
              ...
              <li className="navigation__item">
                <button
                  className="navigation__item-btn"
                  onClick={() => scrollView(portfolio, setToggleMenu)}
                >
              ...
              <li className="navigation__item">
                <button
                  className="navigation__item-btn"
                  onClick={() => scrollView(contact, setToggleMenu)}
                >
